...
super1 = "superman@super.com"
super2 = "wonderwoman@wonder.com"
date1 = Date.new(2023,5,6)
date2 = Date.new(2024,7,19)
schoolProject = Project.create({name: "Project", due_date: date1, group_supervisor: super1})
...
anotherProject = Project.create({name: "Project for Random Team", due_date: date2, group_supervisor: super2})
